...
const technical = [
  ...
  },
  {
    ...
    points: [
      ...
      "1st round: questions will be displayed and the teams have to write the answers.",
      "2nd round: 10 teams will be selected from the previous round and they are competed.",
      "The final round:6 teams out of 10 from the previous round will compete.",
      "Registration fee is Rs. 100/-.",
      "COORDINATORS: PARIMALA DEVI(8807342948), NIRMALKUMAR(9790585710)",
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      "COORDINATORS: ANURAGAA S (6381278692), THIRUMURUGAN S(9629701158)",
    ],
  },
  {
    ...
    points: [
      " A team can consist of two members.",
      "Both Hollywood( especially Marvel and DC) and Kollywood( science fiction) movies included.",
  ...
  {
    title: "Triad (Googler, BrandBlitz, Electric Fence)",
    ...
    points: [
      ...
      "Part 1: Googler (random word will be displayed where the competitors have to find the correct technical word hidden in it.) Part 2: BrandBltiz ( logos will be displayed and the participants have to find the answers of it), Part 3: Electric Fence( copper cable - circuit)",
      "Registration fee is Rs. 100/-",
  ...
  },
  {
    ...
    points: [
      "A team can consist of two members.",
      "There will be Three rounds where only one have to code and the other have to guide and during next level the next person has to code.",
      "Registration fee is Rs. 100/team.",
      "COORDINATORS: SANGESH S(8870073053), MANJUNNATH (6309601909), SIVABHARATH K(9487947750)",
    ],
  },
  {
    title: "Hunt the Code",
...
const literary = [
  ...
  },
  {
    ...
    points: [
      "Solo event.",
      "The participant is given a commodity to sell and has to convince the customer (judges) to buy it.",
...
const esports = [
  ...
  },
  {
    ...
    points: [
      ...
      "Coordinators: Gokul Krishna(8667579648)",
    ],
  },
  {
    title: "Mini Militia",
